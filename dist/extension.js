...
async function appendToChat(query, message) {
...
This is the result of the query:${message}`;
  try {
    const tmpFile = import_tmp.default.fileSync({ postfix: ".txt" });
...
function activate(context) {
  const disposable = vscode2.commands.registerCommand("codyarchitect.websearch", webSearch);
